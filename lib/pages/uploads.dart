...
class UploadsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(
        child: Padding(
          padding: EdgeInsets.all(ScreenUtils.width(context, 0.04)),
          child: Column(
            children: [
              const Spacer(flex: 2),
              SizedBox(
            ...
            button ??
                ElevatedButton(
                  ...
                  style: ElevatedButton.styleFrom(
                    minimumSize: Size(ScreenUtils.width(context, 0.8), 48),
                  ...
                  child: Text(
                    (btnText ?? "Go Back To The Home Page").toUpperCase(),
                    style: TextStyle(
...
const underMaintenanceIllustration =
